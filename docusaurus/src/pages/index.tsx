          ...
          <div className={styles.footerContainer}>
            <div className={styles.footerContent}>
              ...
              <div className={styles.footerLinks}>
                ...
                <div className={styles.footerColumn}>
                  ...
                  <ul className={styles.footerLinkList}>
                    <li><a href="https://github.com/Ayeshanazeer71/-Physical-AI-Humanoid-Robotics-book" target="_blank" rel="noopener noreferrer" className={styles.footerLink}>GitHub</a></li>
            ...
            <div className={styles.footerBottom}>
              <div className={styles.footerSocial}>
                <a href="https://github.com/Ayeshanazeer71/-Physical-AI-Humanoid-Robotics-book" target="_blank" rel="noopener noreferrer" className={styles.footerSocialLink} aria-label="GitHub">
