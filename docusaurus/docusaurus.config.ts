...
const config: Config = {
  ...
  url: 'https://Ayeshanazeer71.github.io',
  ...
  organizationName: 'Ayeshanazeer71', // Usually your GitHub org/user name.
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/Ayeshanazeer71/-Physical-AI-Humanoid-Robotics-book/edit/main/docusaurus/',
          routeBasePath: 'docs',
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/Ayeshanazeer71/-Physical-AI-Humanoid-Robotics-book',
          label: 'GitHub',
          position: 'right',
        },
      ],
